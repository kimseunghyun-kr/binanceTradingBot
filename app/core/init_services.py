...
if settings.MONGO_URI:
    mongo_async = AsyncIOMotorClient(settings.MONGO_URI)
    mongo_sync  = MongoClient(settings.MONGO_URI)

    mongo_db_async = mongo_async[settings.MONGO_DB]
    mongo_db_sync  = mongo_sync[settings.MONGO_DB]
